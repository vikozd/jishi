...
public class MyListInFavoritesAdapter extends BaseAdapter{
	...
	public MyListInFavoritesAdapter(Context context,List<MyFavorites> ll,int RightWidth){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=LayoutInflater.from(mContext).inflate(R.layout.myfavorites_item, parent,false);
		...
		if(myFavorites.getvPreviewImageURL().equals("null")){
			viewHolder.ssImageView.setBackgroundResource(R.drawable.preview);
		}else{
