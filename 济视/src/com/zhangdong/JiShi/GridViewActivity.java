...
public class GridViewActivity extends FinalActivity {
	...
	@ViewInject(id =R.id.gv_bodypart) GridView gv_body;
	@ViewInject(id =R.id.tv_bodypart) TextView tv_bodypart;
	...
	private void initGridView(){
		...
		String httpUrl=Path.getPath()+"WS_GetVideoCategoryByBodyParts.asmx/GetVideoCategoryByBodyParts";
		...
		http.post(httpUrl, params,new AjaxCallBack<String>() {
			...
			public void onSuccess(String t) {
				...
				try {
					...
					mGridViewAdapter=new MyGridViewAdapter(getApplicationContext(), ll);
